            ...
            <div className="section-shell relative grid min-h-screen grid-cols-1 items-center gap-16 pt-24 lg:grid-cols-2 lg:gap-8 lg:pt-0">
                ...
                >
                    ...
                    <motion.h1
                        ref={nameRef}
                        variants={fadeUp}
                        className="text-5xl font-black leading-tight tracking-tight text-slate-100 sm:text-7xl"
                    >
                        {profile.name}
                    </motion.h1>
                    ...
                    <motion.div variants={fadeUp} className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
                        ...
                        <motion.a
                            href="#projects"
                            className="group inline-flex h-12 transform-gpu items-center justify-center gap-2 rounded-xl border border-slate-700 bg-slate-800/50 px-8 font-semibold text-slate-200 backdrop-blur-sm transition-[background-color,border-color,color,transform] duration-150 will-change-transform hover:border-teal-500/50 hover:bg-slate-700/50 hover:text-white"
                            whileHover={{ y: -2 }}
                            whileTap={{ scale: 0.98 }}
                        >
                            View Projects
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative z-10 flex flex-col h-full">
                                            <div className="mb-4 inline-flex h-12 w-12 transform-gpu items-center justify-center rounded-xl bg-slate-800/80 border border-slate-700 text-teal-400 transition-[background-color,border-color,transform] duration-150 will-change-transform group-hover:scale-110 group-hover:bg-teal-500/20 group-hover:border-teal-500/30">
